...
#import "MetalUniformViewController.h"
...
@interface MetalUniformViewController ()
#if !TARGET_IPHONE_SIMULATOR
{
...
@implementation MetalUniformViewController
...
#else
    self.renderer = [MetalUniformStreamRenderer new];
